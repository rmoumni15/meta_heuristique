...
if __name__ == '__main__':
    ...
    parser.add_argument('--taboo_period', type=int, default=10,
                        help="le nombre d'itérations ou la permutation inverse est interdite pour la méthode tabou")
    parser.add_argument('--export', type=bool, default=True, help="Exporter les résultats dans un fichier Excel")
